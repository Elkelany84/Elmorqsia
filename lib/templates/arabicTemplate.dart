...
class TemplateArabicForm extends StatefulWidget {
  @override
  _TemplateArabicFormState createState() => _TemplateArabicFormState();
}

class _TemplateArabicFormState extends State<TemplateArabicForm> {
...
// Default positions (percentage of page dimensions)
  double titleXPercent = 0.43; // 10% from left
  double titleYPercent = 0.24; // 10% from top
  double categoryXPercent = 0.1;
  double categoryYPercent = 0.15;
  double descriptionXPercent = 0.1;
  double descriptionYPercent = 0.2;
  double priorityXPercent = 0.6;
  double priorityYPercent = 0.15;
  double notesXPercent = 0.1;
  double notesYPercent = 0.3;
  double statusXPercent = 0.6;
  double statusYPercent = 0.2;
  double dateXPercent = 0.1;
  double dateYPercent = 0.9;

  // Custom positioning values for PDF elements
  double dedicatedToX = 150; //Horizontal
  double dedicatedToY = 205; //Vertical
  double categoryX = 50;
  ...
  // Add this function to load the Arabic font
        ...
        build: (pw.Context context) {
          return pw.Stack(
            children: [
              ...
              // Convert percentage positions to exact coordinates
              // _buildPositionedText(
              //   _field1Controller.text,
              //   titleXPercent * pageWidth,
              //   titleYPercent * pageHeight,
              //   fontSize: 20,
              //   fontWeight: pw.FontWeight.bold,
              //   maxWidth: 250.00,
              //   font: arabicFont,
  ...
  // Helper method to create positioned text with exact coordinates
  pw.Positioned _buildPositionedText(
    String text,
    double left,
    double top, {
    double? maxWidth,
    ...
    return pw.Positioned(
      ...
      child: pw.Container(
        constraints:
            maxWidth != null ? pw.BoxConstraints(maxWidth: maxWidth) : null,
        child: pw.Text(
          textDirection: pw.TextDirection.rtl,
          text,
          style: pw.TextStyle(
